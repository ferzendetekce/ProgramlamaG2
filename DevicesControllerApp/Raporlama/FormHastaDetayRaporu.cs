...
{
    public partial class FormHastaDetayRaporu : Form
    {
        ...
        public FormHastaDetayRaporu(string hastaAdi, string rapor)
        {
        ...
        private void LoadReport()
        {
            ...
            {
                // Başlık güncelle
                lblBaslik.Text = $"Hasta Detay Raporu - {hastaAdi}";
                this.Text = $"Hasta Detay Raporu - {hastaAdi}";
        ...
        private void FormatReport()
        {
            try
            {
                ...
                {
                    int index = txtRapor.Text.IndexOf(baslik);
                    if (index >= 0)
                    {
                        txtRapor.Select(index, baslik.Length);
                ...
                int baslikIndex = txtRapor.Text.IndexOf("HASTA DETAY RAPORU");
                if (baslikIndex >= 0)
                {
                    txtRapor.Select(baslikIndex, "HASTA DETAY RAPORU".Length);
        ...
        private void InitializeComponent()
        {
            ...
            this.lblBaslik.Text = "Hasta Detay Raporu";
